...
| `lambda-egress-proxy` | HTTP front door called by an external AWS Lambda; forwards to data-ingestion | off |
...
| `lambdaEgressProxy.enabled` | `false` | Opt-in; set the real image before installing |
